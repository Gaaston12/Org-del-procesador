;PROGRAMA: Se restan dos números. Hay que tener en cuenta que los labels se tienen que mover en las partes indicadas de los registros. Si movemos en label que ocupa un byte a eax, deberíamos moverlo a al, y no a eax completo, ya que al hacerlo, estaríamos trayendo los demás labels tambien al registro. 
...
l2 dw 1;				;Declaro un label de tipo word (2 bytes) y le asigno el valor 2000 en decimal
l3 dd 2;
l4 dd 3;
l5 dd 4;
